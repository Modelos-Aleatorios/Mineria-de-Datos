...
Podemos ver que son `r length(varsvo)` campañas Estas son: `r varsvo`. Sin embargo, hay `r lenght(varsv)` campañas con al menos una impresión. Las campañas con al menos una impresión son `r varsv`.

```{r}
data.frame(table(data_original$Adgroup))
```
