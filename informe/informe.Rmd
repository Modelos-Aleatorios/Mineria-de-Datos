...
El coeficiente de $R^2$ en este caso nos dio `r summary(lm)$adj.r.square*100`%. Las pruebas con respecto a los residuales y la signigicancia de cada variable se encuentran en el documento "correlación.pdf".
...
El valor de $R^2$ es `r summary(lm)$adj.r.square*100`%, aunque no es un valor muy alto, este modelo resulto ser el mejor, ver documento "correlacion.pdf".
