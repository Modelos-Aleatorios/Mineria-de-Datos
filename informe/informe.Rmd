...
- Ordenado por `Clicks`
```{r, echo=FALSE}
kable(df_final[order(df_final$Clicks),],digits = 2)
```

- Ordenado por `Impr`
```{r, echo=FALSE}
kable(df_final[order(df_final$Impr),],digits = 2)
```
...
- Ordenado por `Costos`
```{r, echo=FALSE}
kable(df_final[order(df_final$Costos),],digits = 2)
```

- Ordenado por `Costc`
```{r, echo=FALSE}
kable(df_final[order(df_final$Costc),],digits = 2)
```
